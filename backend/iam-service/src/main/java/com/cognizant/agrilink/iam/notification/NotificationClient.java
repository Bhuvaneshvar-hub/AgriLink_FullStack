...
/**
 * Emits targeted, workflow-generated alerts to notification-service on IAM domain
 * events (e.g. an account being approved).
 *
...
public class NotificationClient {
    ...
    public NotificationClient(@Qualifier("notificationRestTemplate") RestTemplate restTemplate) {
