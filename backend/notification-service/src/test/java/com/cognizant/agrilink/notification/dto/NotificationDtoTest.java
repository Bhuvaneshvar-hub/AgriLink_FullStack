...
class NotificationDtoTest {
	...
	void allArgsConstructorSetsAllFields() {
		NotificationDto dto = new NotificationDto(1, 11, "msg", NotificationCategory.CropAdvisory, NotificationStatus.UN,
		...
		assertThat(dto.getCategory()).isEqualTo(NotificationCategory.CropAdvisory);
	...
	void builderSetsAllFields() {
		...
		assertThat(dto.getCategory()).isEqualTo(NotificationCategory.Subsidy);
	...
	void equalsAndHashCodeMatchForSameValues() {
		NotificationDto a = new NotificationDto(1, 11, "msg", NotificationCategory.CropAdvisory, NotificationStatus.UN, LocalDate.of(2026, 6, 15));
		NotificationDto b = new NotificationDto(1, 11, "msg", NotificationCategory.CropAdvisory, NotificationStatus.UN, LocalDate.of(2026, 6, 15));
	...
	void equalsReturnsFalseForDifferentValues() {
		NotificationDto a = new NotificationDto(1, 11, "msg", NotificationCategory.CropAdvisory, NotificationStatus.UN, LocalDate.of(2026, 6, 15));
		NotificationDto b = new NotificationDto(2, 22, "other", NotificationCategory.Subsidy, NotificationStatus.RD, LocalDate.of(2025, 1, 1));
	...
	void toStringContainsFieldValues() {
		NotificationDto dto = new NotificationDto(1, 11, "Sowing", NotificationCategory.CropAdvisory, NotificationStatus.UN,
				LocalDate.of(2026, 6, 15));
