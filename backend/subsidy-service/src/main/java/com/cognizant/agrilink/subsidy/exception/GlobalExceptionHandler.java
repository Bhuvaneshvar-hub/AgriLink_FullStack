...
/**
 * Centralised exception handling for the subsidy service.
 *
...
public class GlobalExceptionHandler {
    ...
    /**
     * Database constraint violation (missing foreign key, duplicate, not-null) -> 409.
     * The raw SQL/constraint detail is logged but never exposed to the caller.
     */
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrity(DataIntegrityViolationException ex,
        ...
        return build(HttpStatus.CONFLICT,
                "The request could not be completed because it violates a data constraint", request);
    }
