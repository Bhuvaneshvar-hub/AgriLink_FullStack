          ...
          <div class="form-section">
            ...
            <div class="form-row-2">
              ...
              <div class="form-group">
                ...
                <input type="text" id="nationalIdNumber" formControlName="nationalIdNumber" placeholder="12-digit Aadhar number"
                  maxlength="12" inputmode="numeric" (input)="restrictToDigits($event)"
                  [class.input-error]="isFieldInvalid('nationalIdNumber')" />
                <span class="error-text" [class.visible]="isFieldInvalid('nationalIdNumber')">National ID must be exactly 12 digits</span>
              </div>
            </div>
            ...
            <div class="form-row-2">
              <div class="form-group">
                ...
                <input type="text" id="village" formControlName="village" maxlength="50"
              ...
              <div class="form-group">
                ...
                <input type="text" id="district" formControlName="district" maxlength="50"
            ...
            <div class="form-row-2">
              ...
              <div class="form-group">
                ...
                <input type="text" id="bankAccountNumber" formControlName="bankAccountNumber"
                  maxlength="18" inputmode="numeric" (input)="restrictToDigits($event)"
                  [class.input-error]="isFieldInvalid('bankAccountNumber')" />
                <span class="error-text" [class.visible]="isFieldInvalid('bankAccountNumber')">
                  {{ registerForm.get('bankAccountNumber')?.errors?.['pattern'] ? 'Enter a valid 9–18 digit account number' : 'Bank account is required' }}
                </span>
              </div>
            </div>
          </div>
